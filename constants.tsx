...
export const DEFAULT_SONGS = [
  {
    ...
    audioUrl: 'https://actions.google.com/sounds/v1/science_fiction/future_music.ogg',
    duration: 32,
    favorite: true
  },
  {
    ...
    audioUrl: 'https://actions.google.com/sounds/v1/ambient/dark_ambience.ogg',
    duration: 45,
    favorite: false
  },
  {
